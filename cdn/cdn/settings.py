...
SECRET_KEY = 'django-insecure-&*)%_^7i91r60(1jpibafl&mhfu0xu0_4ot80vg4_n@d29$2=t'
...
INSTALLED_APPS = [
    'stat_cdnnow.apps.StatCdnnowConfig',
    'traffic_metric.apps.TrafficMetricConfig',
